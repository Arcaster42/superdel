  ...
  <b-list-group>
    <b-card bg-variant="dark" text-variant="white" title="Checkout">
      <b-card-text>
        ...
        <b-card-text class="text-white font-weight-bold" >Total: {{this.cartTotal}}</b-card-text>
...
export default {
  ...
  data: () => ({
    ...
    groceryItems: {
      italian: [
      { productTitle: 'Olive Oil ', photo: olive, productDetails: 'Straight from Italy', productPrice: 500},
      { productTitle: 'Cheese', photo: mozza, productDetails: 'Fresh Italian Mozzarella', productPrice: 800},
      { productTitle: 'Tomato', photo: tomato, productDetails: 'Juicy Heirloom Tomatoes', productPrice: 150},
      { productTitle: 'Pasta', photo: pasta, productDetails: 'Organic Wheat Pasta', productPrice: 300},
      { productTitle: 'Basil', photo: basil, productDetails: 'Fresh Milanese Basil', productPrice: 25},
      { productTitle: 'Tomato Sauce', photo: sauce, productDetails: 'Organic Basil Tomato Sauce', productPrice: 500},
    ],
    basics: [
      { productTitle: 'Eggs', photo: eggs, productDetails: 'Free Range Organic', productPrice: 150},
      { productTitle: 'Milk', photo: milk, productDetails: 'Local Organic Whole Milk', productPrice: 180},
      { productTitle: 'Rice', photo: rice, productDetails: 'Fresh Rice', productPrice: 850},
      { productTitle: 'Salt', photo: salt, productDetails: 'Generic Salt', productPrice: 300},
      { productTitle: 'Pepper', photo: pepper, productDetails: 'Generic Pepper', productPrice: 350},
      { productTitle: 'Water', photo: water, productDetails: 'Glacial Water From French Alps', productPrice: 200}
    ],
    japanese: [
      { productTitle: 'Bulldog Sauce', photo: bulldog, productDetails: 'Tonaktsu Sauce', productPrice: 250},
      { productTitle: 'Seaweed', photo: seaweed, productDetails: 'From Hokkaido', productPrice: 160},
      { productTitle: 'Natto', photo: natto, productDetails: 'From Nagano', productPrice: 90},
      { productTitle: 'Tea', photo: tea, productDetails: 'From China', productPrice: 750},
      { productTitle: 'Miso', photo: miso, productDetails: 'From Japan', productPrice: 600},
      { productTitle: 'Tofu', photo: tofu, productDetails: 'Made this morning', productPrice: 120}
    ]},
    error: null,
